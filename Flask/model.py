...
from torchvision.models import ResNet34_Weights  # Fix for pretrained weights
...
class Plant_Disease_Model(nn.Module):
    def __init__(self):
        super().__init__()
        self.network = models.resnet34(weights=ResNet34_Weights.IMAGENET1K_V1)  # Updated weights loading
